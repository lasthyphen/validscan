...
export declare class UTXOSet extends StandardUTXOSet<UTXO> {
     ...
     * @param asOf Optional. The timestamp to verify the transaction against as a {@link https://github.com/indutny/bn.js/|BN}
     */
    buildSECPMintTx: (networkid: number, blockchainid: Buffer, mintOwner: SECPMintOutput, transferOwners: Array<SECPTransferOutput>, fromAddresses: Array<Buffer>, changeAddresses: Array<Buffer>, mintUTXOID: string, fee?: BN, feeAssetID?: Buffer, memo?: Buffer, asOf?: BN) => UnsignedTx;
    /**
    * Creates an unsigned Create Asset transaction. For more granular control, you may create your own
    * [[CreateAssetTX]] manually (with their corresponding [[TransferableInput]]s, [[TransferableOutput]]s).
    *
