...
export declare class AVMAPI extends JRPCAPI {
     ...
     *
     */
    getUTXOs: (addresses: Array<string> | string, sourceChain?: string, limit?: number, startIndex?: number, persistOpts?: PersistanceOptions) => Promise<UTXOSet>;
    /**
    ...
    buildSECPMintTx: (utxoset: UTXOSet, mintOwner: SECPMintOutput, transferOwners: Array<SECPTransferOutput>, fromAddresses: Array<string>, changeAddresses: Array<string>, mintUTXOID: string, memo?: PayloadBase | Buffer, asOf?: BN) => Promise<any>;
    /**
    * Creates an unsigned transaction. For more granular control, you may create your own
    * [[UnsignedTx]] manually (with their corresponding [[TransferableInput]]s, [[TransferableOutput]]s, and [[TransferOperation]]s).
    *
